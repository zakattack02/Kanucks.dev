...
const getRepos = async () => {
    ...
    for (let i = 1; i <= maxPages; i++) {
        console.log(`Fetching page ${i} of repositories.`);
        res = await fetch(
        ...
        console.log(`Page ${i} data fetched:`, data);
        repos = repos.concat(data);
    }
    console.log('All repositories fetched:', repos);
...
const displayRepos = (repos) => {
    ...
    for (const repo of repos) {
        ...
        console.log(`Adding repository to list: ${repo.name}`);
